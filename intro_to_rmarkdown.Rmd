...
csl: "css/harvard-cite-them-right.csl"
output: 
...
```
## 3 Components: Text = pandoc's markdown
...
## Reference management with BiBTeX {.build}
...
+ Use `citation("package-name")` to produce a BiBTeX entry if you want to reference a particular R package
+ More information on citations [here](https://rmarkdown.rstudio.com/authoring_bibliographies_and_citations.html)
